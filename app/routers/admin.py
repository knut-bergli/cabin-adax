...
async def add_room_post(name: str = Form(...), db: db_dependency = None):
    room = Room(name=name)
...
@template(template_file='admin/edit_room.pt')
async def edit_room_get(room_id: int, db: db_dependency):
...
async def edit_room_post(room_id: int, name: str = Form(...), db: db_dependency = None):
...
@template(template_file='admin/edit_heater.pt')
async def edit_heater_get(heater_id: int, db: db_dependency):
...
async def delete_heater(heater_id: int, db: db_dependency):
