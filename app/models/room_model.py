...
class Room(SQLModel, table=True):
    ...
    # def __repr__(self):
    #     return f"Room(id={self.id}, name='{self.name}', heaters={len(self.heaters)}, average_temp={0}°C)"
    #
    # def __str__(self):
    #     return f"Room: {self.name} - Average Temp: {self.average_temp:.1f}°C, Setpoint: {0}°C"
